...
### 1.1 trae和qoder自动运行终端无法操作conda环境的问题

解决方法：

1. 让ai写一个bat文件，并让ai调用这个文件
...
增加
{
  ...
  "quest": {
    "executionShell": "cmd.exe",
    "executionShellArgs": ["/c"]
  }
}
似乎解决了
...
#trae 的 setting
{
    ...
    "python.venvPath": "D:\\AnacondaEnvs",
    "python.condaPath": "D:\\MyProgrammeFile\\anaconda3\\_conda.exe",
...
第一步，打开[OpenClaw (原 Clawdbot)--火山方舟大模型服务平台-火山引擎](https://www.volcengine.com/docs/82379/2183190?lang=zh) 或 [OpenClaw（原 Clawdbot、Moltbot）-大模型服务平台百炼(Model Studio)-阿里云帮助中心](https://help.aliyun.com/zh/model-studio/openclaw#step-config-manual-title)

第二步，安装nodejs，重启电脑

第三步，按照网站中要求，管理员打开powershell

`iwr -useb https://openclaw.ai/install.ps1 | iex`

第四步，按照网站上的指示配置

第五步，打开opneclaw.json，将阿里云中的json全部替换成自己的模型，将key和url也替换成自己的

第六步，常用命令，管理员powershell中`openclaw gateway ` ` openclaw gateway stop`
